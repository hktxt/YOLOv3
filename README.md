...
Followed their codes, helped me walkthrough the yolov3 algorithm. Then I reconstructed & rewrited them to try to reimplement it. It is recommended to read their codes to see the specific implementation steps and logic. Also you can just go to the [Dev](/Dev) for more details of YOLOv3.
